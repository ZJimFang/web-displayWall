function Girl(){
    ...
    $('.pic02').attr('src','../img/sport5.jpg');
    $('.pic03').attr('src','../img/sport6.jpeg');
    $('.pic04').attr('src','../img/sport1.jpeg');
    $('.pic05').attr('src','../img/sport2.jpeg');
    $('.pic06').attr('src','../img/sport3.jpeg');
    ...
    document.getElementById('link02').href="../html/sport05.html";
    document.getElementById('link03').href="../html/sport06.html";
    document.getElementById('link04').href="../html/sport01.html";
    document.getElementById('link05').href="../html/sport02.html";
    document.getElementById('link06').href="../html/sport03.html";
};
function Boy(){
    ...
    $('.pic06').attr('src','../img/sport4.jpeg');
    ...
    document.getElementById('link06').href="../html/sport04.html";
};
function Week(){
