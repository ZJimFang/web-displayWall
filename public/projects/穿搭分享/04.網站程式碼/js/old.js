function Girl(){
    $('.pic01').attr('src','../img/old4.jpeg');
    $('.pic02').attr('src','../img/old5.jpeg');
    $('.pic03').attr('src','../img/old6.jpeg');
    ...
    document.getElementById('link01').href="../html/old04.html";
    document.getElementById('link02').href="../html/old05.html";
    document.getElementById('link03').href="../html/old06.html";
...
function Boy(){
    ...
    document.getElementById('link01').href="../html/old05.html";
    ...
    document.getElementById('link05').href="../html/old01.html";
