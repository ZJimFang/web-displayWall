function Girl(){
    $('.pic01').attr('src','../img/fun4.jpeg');
    $('.pic02').attr('src','../img/fun5.jpeg');
    $('.pic03').attr('src','../img/fun6.jpeg');
    $('.pic04').attr('src','../img/fun1.jpeg');
    $('.pic05').attr('src','../img/fun2.jpeg');
    $('.pic06').attr('src','../img/fun3.jpeg');
    ...
    document.getElementById('link01').href="../html/fun04.html";
    document.getElementById('link02').href="../html/fun05.html";
    document.getElementById('link03').href="../html/fun06.html";
    document.getElementById('link04').href="../html/fun01.html";
    document.getElementById('link05').href="../html/fun02.html";
    document.getElementById('link06').href="../html/fun03.html";
...
function Boy(){
    ...
    document.getElementById('link06').href="../html/fun04.html";
};
function Week(){
